...
use {
    ...
    pallet_external_validators::traits::{
        ActiveEraInfo, EraIndex, EraIndexProvider, InvulnerablesProvider,
    },
...
impl crate::types::SendMessage for MockOkOutboundQueue {
    type Ticket = ();
    type Message = ();
    fn build(_: &crate::types::SlashDataUtils) -> Option<Self::Ticket> {
        Some(())
    }
...
// FIXME: duplicate with external-validators-rewards
