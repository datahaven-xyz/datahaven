...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_641_416, 4257)
			// Standard Error: 2_135
			.saturating_add(Weight::from_parts(122_712, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_588_589, 3487)
			// Standard Error: 1_298
			.saturating_add(Weight::from_parts(69_293, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(28_514_583, 3487)
			// Standard Error: 1_518
			.saturating_add(Weight::from_parts(211_665, 0).saturating_mul(r.into()))
