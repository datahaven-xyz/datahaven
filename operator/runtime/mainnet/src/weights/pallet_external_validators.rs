...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_074_744, 4003)
			// Standard Error: 19_291
			.saturating_add(Weight::from_parts(155_755, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_009_146, 3487)
			// Standard Error: 12_012
			.saturating_add(Weight::from_parts(98_853, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(21_283_843, 3487)
			// Standard Error: 54_049
			.saturating_add(Weight::from_parts(174_656, 0).saturating_mul(r.into()))
