...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(35_855_760, 4003)
			// Standard Error: 58_340
			.saturating_add(Weight::from_parts(274_239, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_710_702, 3487)
			// Standard Error: 41_805
			.saturating_add(Weight::from_parts(332_797, 0).saturating_mul(b.into()))
	...
	fn force_era() -> Weight {
		...
		Weight::from_parts(100_802_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(30_941_272, 3487)
			// Standard Error: 59_382
			.saturating_add(Weight::from_parts(494_227, 0).saturating_mul(r.into()))
