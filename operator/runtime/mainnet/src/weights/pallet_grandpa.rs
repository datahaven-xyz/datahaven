...
impl<T: frame_system::Config> pallet_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn report_equivocation(v: u32, n: u32, ) -> Weight {
		...
		Weight::from_parts(164_997_104, 4625)
			// Standard Error: 328
			.saturating_add(Weight::from_parts(241, 0).saturating_mul(v.into()))
			// Standard Error: 214_046
			.saturating_add(Weight::from_parts(244_077, 0).saturating_mul(n.into()))
