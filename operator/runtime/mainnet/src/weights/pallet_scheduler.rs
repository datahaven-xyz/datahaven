...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(8_132_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(8_699_327, 13328)
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_247_000, 3605)
			// Standard Error: 5
	...
	fn execute_dispatch_signed() -> Weight {
		...
		Weight::from_parts(10_608_000, 3997)
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_709_206, 13328)
			// Standard Error: 1_739
			.saturating_add(Weight::from_parts(479_563, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_493_987, 13328)
			// Standard Error: 1_273
			.saturating_add(Weight::from_parts(734_576, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_968_971, 13328)
			// Standard Error: 2_931
			.saturating_add(Weight::from_parts(518_729, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		//  Estimated: `13328`
		// Minimum execution time: 24_608_000 picoseconds.
		Weight::from_parts(24_573_857, 13328)
			// Standard Error: 1_437
			.saturating_add(Weight::from_parts(770_794, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_365_402, 13328)
			// Standard Error: 504
			.saturating_add(Weight::from_parts(30_282, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(34_175_000, 13328)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		Weight::from_parts(41_597_000, 13328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:0)
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(32_185_000, 13328)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(40_723_000, 13328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
