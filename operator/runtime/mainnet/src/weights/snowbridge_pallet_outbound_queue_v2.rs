...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue_v2::WeightInfo for WeightInfo<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(47_683_000, 1594)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(65_022_000, 2680)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(25_186_000, 1687)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process() -> Weight {
		...
		//  Measured:  `180`
		//  Estimated: `1493`
		// Minimum execution time: 840_492_000 picoseconds.
		Weight::from_parts(924_952_000, 1493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn submit_delivery_receipt() -> Weight {
		...
		Weight::from_parts(146_420_000, 3537)
