...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue_v2::WeightInfo for WeightInfo<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(28_743_000, 1594)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(42_358_000, 2680)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(17_808_000, 1687)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process() -> Weight {
		...
		//  Measured:  `180`
		//  Estimated: `1493`
		// Minimum execution time: 708_754_000 picoseconds.
		Weight::from_parts(726_177_000, 1493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn submit_delivery_receipt() -> Weight {
		...
		//  Measured:  `498`
		//  Estimated: `3537`
		// Minimum execution time: 112_566_000 picoseconds.
		Weight::from_parts(113_823_000, 3537)
