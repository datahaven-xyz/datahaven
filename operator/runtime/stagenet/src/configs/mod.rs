...
parameter_types! {
    /// Safe mode enter deposit for stagenet
    pub SafeModeEnterDeposit: Balance = StagenetSafeModeConfig::enter_deposit();
    /// Safe mode extend deposit for stagenet
    pub SafeModeExtendDeposit: Balance = StagenetSafeModeConfig::extend_deposit();
    /// Stagenet whitelist for safe mode - more permissive than mainnet
...
impl pallet_safe_mode::Config for Runtime {
    ...
    // Stagenet: Allow permissionless entry/extend with deposits (more testing-friendly)
