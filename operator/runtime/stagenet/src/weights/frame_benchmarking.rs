...
// --output
// runtime/stagenet/src/weights/frame_benchmarking.rs
// --steps
// 2
// --repeat
// 2
...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn division(i: u32, ) -> Weight {
		...
		Weight::from_parts(151_500, 0)
	}
	fn hashing() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 21_216_225_000 picoseconds.
		Weight::from_parts(21_239_898_000, 0)
	}
	...
	fn sr25519_verification(i: u32, ) -> Weight {
		...
		Weight::from_parts(148_000, 0)
			...
			.saturating_add(Weight::from_parts(39_835_865, 0).saturating_mul(i.into()))
	}
}
