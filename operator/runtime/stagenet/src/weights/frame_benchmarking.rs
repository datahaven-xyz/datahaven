...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn division(i: u32, ) -> Weight {
		...
		Weight::from_parts(357_500, 0)
	}
	fn hashing() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 37_554_185_000 picoseconds.
		Weight::from_parts(38_196_932_000, 0)
	}
	...
	fn sr25519_verification(i: u32, ) -> Weight {
		...
		Weight::from_parts(312_500, 0)
			// Standard Error: 242_680
			.saturating_add(Weight::from_parts(87_931_295, 0).saturating_mul(i.into()))
	}
}
