...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_967_535, 4003)
			// Standard Error: 6_052
			.saturating_add(Weight::from_parts(94_464, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_581_419, 3487)
			// Standard Error: 24_099
			.saturating_add(Weight::from_parts(75_080, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_367_141, 3487)
			// Standard Error: 6_368
			.saturating_add(Weight::from_parts(188_858, 0).saturating_mul(r.into()))
