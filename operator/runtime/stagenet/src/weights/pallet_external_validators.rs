...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_469_387, 4003)
			// Standard Error: 7_215
			.saturating_add(Weight::from_parts(30_612, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_494_949, 3487)
			// Standard Error: 5_050
			.saturating_add(Weight::from_parts(5_050, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		//  Estimated: `3487`
		// Minimum execution time: 15_000_000 picoseconds.
		Weight::from_parts(15_414_141, 3487)
