...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(35_667_392, 4003)
			// Standard Error: 70_272
			.saturating_add(Weight::from_parts(339_107, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_804_141, 3487)
			// Standard Error: 42_069
			.saturating_add(Weight::from_parts(238_358, 0).saturating_mul(b.into()))
	...
	fn force_era() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 25_641_000 picoseconds.
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_642_207, 3487)
			// Standard Error: 131_078
			.saturating_add(Weight::from_parts(317_292, 0).saturating_mul(r.into()))
