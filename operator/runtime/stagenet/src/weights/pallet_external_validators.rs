...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(32_587_795, 4262)
			// Standard Error: 6_822
			.saturating_add(Weight::from_parts(169_471, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_379_257, 3487)
			// Standard Error: 5_063
			.saturating_add(Weight::from_parts(120_234, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(28_257_323, 3487)
			// Standard Error: 4_555
			.saturating_add(Weight::from_parts(243_771, 0).saturating_mul(r.into()))
