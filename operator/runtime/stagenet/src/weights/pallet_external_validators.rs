...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_806_132, 4003)
			// Standard Error: 4_010
			.saturating_add(Weight::from_parts(95_867, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_182_434, 3487)
			// Standard Error: 4_464
			.saturating_add(Weight::from_parts(51_565, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_233_313, 3487)
			// Standard Error: 15_394
			.saturating_add(Weight::from_parts(189_186, 0).saturating_mul(r.into()))
