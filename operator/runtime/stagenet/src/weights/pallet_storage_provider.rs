...
// --output
// runtime/stagenet/src/weights/pallet_storage_provider.rs
// --steps
// 50
// --repeat
// 20
...
use crate::pallet_storage_providers;
...
impl<T: frame_system::Config> pallet_storage_providers::WeightInfo for WeightInfo<T> {
	...
	fn request_msp_sign_up() -> Weight {
		...
		Weight::from_parts(45_000_000, 5628)
	...
	fn request_bsp_sign_up() -> Weight {
		...
		Weight::from_parts(41_000_000, 5628)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Providers::SignUpRequests` (r:1 w:1)
	...
	fn confirm_sign_up_bsp() -> Weight {
		...
		Weight::from_parts(13_000_000, 5628)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn confirm_sign_up_msp() -> Weight {
		...
		Weight::from_parts(21_000_000, 5628)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(6_u64))
	}
	/// Storage: `Providers::SignUpRequests` (r:1 w:1)
	...
	fn cancel_sign_up() -> Weight {
		...
		Weight::from_parts(30_000_000, 5628)
	...
	fn msp_sign_off(n: u32, ) -> Weight {
		...
		// Minimum execution time: 41_000_000 picoseconds.
		Weight::from_parts(39_915_253, 8186)
			// Standard Error: 5_659
			.saturating_add(Weight::from_parts(3_081_598, 0).saturating_mul(n.into()))
	...
	fn bsp_sign_off() -> Weight {
		...
		//  Estimated: `4624`
		// Minimum execution time: 40_000_000 picoseconds.
		Weight::from_parts(42_000_000, 4624)
	...
	fn change_capacity_bsp_less_deposit() -> Weight {
		...
		Weight::from_parts(38_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(7_u64))
	...
	fn change_capacity_bsp_more_deposit() -> Weight {
		...
		Weight::from_parts(47_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(7_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `Providers::AccountIdToMainStorageProviderId` (r:1 w:0)
	...
	fn change_capacity_msp_less_deposit() -> Weight {
		...
		Weight::from_parts(34_000_000, 4608)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Providers::AccountIdToMainStorageProviderId` (r:1 w:0)
	...
	fn change_capacity_msp_more_deposit() -> Weight {
		...
		Weight::from_parts(45_000_000, 4608)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Providers::AccountIdToMainStorageProviderId` (r:1 w:0)
	...
	fn add_value_prop() -> Weight {
		...
		Weight::from_parts(19_000_000, 4608)
	...
	fn make_value_prop_unavailable() -> Weight {
		...
		Weight::from_parts(12_000_000, 4608)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn add_multiaddress() -> Weight {
		...
		//  Estimated: `4624`
		// Minimum execution time: 13_000_000 picoseconds.
		Weight::from_parts(14_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Providers::AccountIdToMainStorageProviderId` (r:1 w:0)
	...
	fn remove_multiaddress() -> Weight {
		...
		//  Estimated: `4624`
		// Minimum execution time: 12_000_000 picoseconds.
		Weight::from_parts(13_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Providers::SignUpRequests` (r:1 w:1)
	...
	fn force_msp_sign_up() -> Weight {
		...
		Weight::from_parts(58_000_000, 5628)
			.saturating_add(T::DbWeight::get().reads(8_u64))
	...
	fn force_bsp_sign_up() -> Weight {
		...
		Weight::from_parts(49_000_000, 5628)
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().writes(8_u64))
	}
	/// Storage: `Providers::MainStorageProviders` (r:1 w:0)
	...
	fn slash_without_awaiting_top_up() -> Weight {
		...
		Weight::from_parts(85_000_000, 6172)
	...
	fn slash_with_awaiting_top_up() -> Weight {
		...
		Weight::from_parts(65_000_000, 6787)
	...
	fn top_up_deposit() -> Weight {
		...
		Weight::from_parts(52_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
	...
	fn delete_provider_bsp() -> Weight {
		...
		Weight::from_parts(33_000_000, 6038)
	...
	fn delete_provider_msp(n: u32, m: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1568 + m * (54 ±0) + n * (83 ±0)`
		//  Estimated: `8186 + m * (2571 ±0) + n * (3598 ±0)`
		// Minimum execution time: 82_000_000 picoseconds.
		Weight::from_parts(27_206_199, 8186)
			// Standard Error: 15_412
			.saturating_add(Weight::from_parts(3_544_904, 0).saturating_mul(n.into()))
			// Standard Error: 15_412
			.saturating_add(Weight::from_parts(2_835_366, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(8_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
	...
	fn stop_all_cycles() -> Weight {
		...
		Weight::from_parts(10_000_000, 4624)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	}
	/// Storage: `Providers::AwaitingTopUpFromProviders` (r:1 w:1)
	/// Proof: `Providers::AwaitingTopUpFromProviders` (`max_values`: None, `max_size`: Some(57), added: 2532, mode: `MaxEncodedLen`)
	...
	fn process_expired_provider_top_up_msp() -> Weight {
		...
		Weight::from_parts(39_000_000, 6172)
