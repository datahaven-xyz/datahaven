...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_500_000, 0)
			...
			.saturating_add(Weight::from_parts(3_374_000, 0).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_000_000, 0)
			...
			.saturating_add(Weight::from_parts(3_533_000, 0).saturating_mul(c.into()))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		// Minimum execution time: 4_000_000 picoseconds.
		Weight::from_parts(5_000_000, 0)
			// Standard Error: 22_522
			.saturating_add(Weight::from_parts(3_349_500, 0).saturating_mul(c.into()))
	}
}
