...
/// Weight functions needed for `snowbridge_pallet_inbound_queue_v2`.
pub trait WeightInfo {
	fn submit() -> Weight;
}

/// Weights for `snowbridge_pallet_inbound_queue_v2` using the DataHaven node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn submit() -> Weight {
		...
		Weight::from_parts(69_298_000, 3537)
