...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(21_089_000, 1594)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(28_999_000, 2680)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(11_936_000, 1687)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process() -> Weight {
		...
		//  Measured:  `180`
		//  Estimated: `1493`
		// Minimum execution time: 459_704_000 picoseconds.
		Weight::from_parts(473_506_000, 1493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
