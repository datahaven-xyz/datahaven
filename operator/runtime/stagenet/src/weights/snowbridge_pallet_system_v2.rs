...
/// Weight functions needed for `snowbridge_pallet_system_v2`.
pub trait WeightInfo {
	fn register_token() -> Weight;
}

/// Weights for `snowbridge_pallet_system_v2` using the DataHaven node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn register_token() -> Weight {
		...
		Weight::from_parts(42_886_000, 4115)
