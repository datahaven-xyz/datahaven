...
/// Returns the mock validator addresses generated by Solidity TestUtils.generateMockValidators(3)
///
/// These addresses are generated by:
/// - keccak256(abi.encodePacked("validator", 1)) -> 44d9bbb95ef2edb95ac42d2988d43c1ffafcdbf9
/// - keccak256(abi.encodePacked("validator", 2)) -> 8947ed9475d56c5d63b12c78fe1095553364661c  
/// - keccak256(abi.encodePacked("validator", 3)) -> be8307baf95ef78cd0753e4bce4cf83b742f3bf4
fn get_expected_validators() -> Vec<AccountId> {
    vec![
        hex_to_bytes20("44d9bbb95ef2edb95ac42d2988d43c1ffafcdbf9").into(),
        hex_to_bytes20("8947ed9475d56c5d63b12c78fe1095553364661c").into(),
        hex_to_bytes20("be8307baf95ef78cd0753e4bce4cf83b742f3bf4").into(),
    ]
}
