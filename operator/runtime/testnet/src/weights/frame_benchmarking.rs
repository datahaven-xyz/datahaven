...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn hashing() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 21_077_758_000 picoseconds.
		Weight::from_parts(21_083_140_000, 0)
	}
	...
	fn sr25519_verification(i: u32, ) -> Weight {
		...
		Weight::from_parts(145_500, 0)
			...
			.saturating_add(Weight::from_parts(40_358_390, 0).saturating_mul(i.into()))
	}
}
