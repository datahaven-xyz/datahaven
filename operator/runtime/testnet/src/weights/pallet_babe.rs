...
impl<T: frame_system::Config> pallet_babe::WeightInfo for WeightInfo<T> {
	...
	fn check_equivocation_proof(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 89_344_000 picoseconds.
		Weight::from_parts(90_106_106, 0)
			// Standard Error: 49_070
			.saturating_add(Weight::from_parts(51_793, 0).saturating_mul(x.into()))
	}
}
