...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_991_642, 4223)
			// Standard Error: 1_609
			.saturating_add(Weight::from_parts(75_808, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_763_002, 3487)
			// Standard Error: 768
			.saturating_add(Weight::from_parts(41_353, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_175_609, 3487)
			// Standard Error: 1_017
			.saturating_add(Weight::from_parts(154_468, 0).saturating_mul(r.into()))
