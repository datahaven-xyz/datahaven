...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_959_183, 4003)
			// Standard Error: 10_204
			.saturating_add(Weight::from_parts(40_816, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_969_696, 3487)
			// Standard Error: 10_101
			.saturating_add(Weight::from_parts(30_303, 0).saturating_mul(b.into()))
