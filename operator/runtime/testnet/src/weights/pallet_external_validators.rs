...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(38_874_397, 4003)
			// Standard Error: 51_618
			.saturating_add(Weight::from_parts(350_102, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(22_529_252, 3487)
			// Standard Error: 57_978
			.saturating_add(Weight::from_parts(233_747, 0).saturating_mul(b.into()))
	...
	fn force_era() -> Weight {
		...
		Weight::from_parts(54_979_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(30_282_343, 3487)
			// Standard Error: 63_188
			.saturating_add(Weight::from_parts(405_156, 0).saturating_mul(r.into()))
