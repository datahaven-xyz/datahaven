...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(29_847_049, 4257)
			// Standard Error: 8_685
			.saturating_add(Weight::from_parts(265_537, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_682_239, 3487)
			// Standard Error: 5_784
			.saturating_add(Weight::from_parts(151_974, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(27_667_736, 3487)
			// Standard Error: 4_276
			.saturating_add(Weight::from_parts(291_855, 0).saturating_mul(r.into()))
