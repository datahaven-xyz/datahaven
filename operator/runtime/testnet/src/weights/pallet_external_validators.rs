...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for WeightInfo<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_399_147, 4003)
			// Standard Error: 12_649
			.saturating_add(Weight::from_parts(108_852, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_930_590, 3487)
			// Standard Error: 3_835
			.saturating_add(Weight::from_parts(48_409, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_539_843, 3487)
			// Standard Error: 16_158
			.saturating_add(Weight::from_parts(179_656, 0).saturating_mul(r.into()))
