...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_543_892, 4003)
			// Standard Error: 4_092
			.saturating_add(Weight::from_parts(104_607, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_784_595, 3487)
			// Standard Error: 6_872
			.saturating_add(Weight::from_parts(54_404, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_093_904, 3487)
			// Standard Error: 8_382
			.saturating_add(Weight::from_parts(182_095, 0).saturating_mul(r.into()))
