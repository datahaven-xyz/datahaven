...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_907_530, 4003)
			// Standard Error: 8_353
			.saturating_add(Weight::from_parts(142_469, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_752_020, 3487)
			// Standard Error: 22_497
			.saturating_add(Weight::from_parts(56_979, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_939_393, 3487)
			// Standard Error: 10_520
			.saturating_add(Weight::from_parts(168_606, 0).saturating_mul(r.into()))
