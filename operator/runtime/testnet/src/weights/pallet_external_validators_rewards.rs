...
/// Weights for `pallet_external_validators_rewards` using the DataHaven node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for DataHavenWeight<T> {
	...
	fn on_era_end() -> Weight {
		...
		//  Measured:  `24165`
		//  Estimated: `27630`
		// Minimum execution time: 1_011_646_000 picoseconds.
		Weight::from_parts(1_034_461_000, 27630)
