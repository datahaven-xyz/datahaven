...
impl<T: frame_system::Config> pallet_message_queue::WeightInfo for WeightInfo<T> {
	...
	fn ready_ring_knit() -> Weight {
		...
		Weight::from_parts(12_898_000, 6212)
	...
	fn ready_ring_unknit() -> Weight {
		...
		Weight::from_parts(11_444_000, 6212)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn service_queue_base() -> Weight {
		...
		Weight::from_parts(6_340_000, 3601)
	...
	fn service_page_base_completion() -> Weight {
		...
		Weight::from_parts(5_832_000, 36310)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::Pages` (r:1 w:1)
	...
	fn service_page_base_no_completion() -> Weight {
		...
		Weight::from_parts(5_694_000, 36310)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_page_item() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 68_657_000 picoseconds.
		Weight::from_parts(89_532_000, 0)
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::ServiceHead` (r:1 w:1)
	/// Proof: `MessageQueue::ServiceHead` (`max_values`: Some(1), `max_size`: Some(33), added: 528, mode: `MaxEncodedLen`)
	...
	fn bump_service_head() -> Weight {
		...
		Weight::from_parts(7_122_000, 3601)
	...
	fn reap_page() -> Weight {
		...
		Weight::from_parts(45_048_000, 36310)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_removed() -> Weight {
		...
		Weight::from_parts(51_992_000, 36310)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_updated() -> Weight {
		...
		Weight::from_parts(67_441_000, 36310)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}
