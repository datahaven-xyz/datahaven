...
impl<T: frame_system::Config> pallet_sudo::WeightInfo for WeightInfo<T> {
	...
	fn set_key() -> Weight {
		...
		Weight::from_parts(13_797_000, 1505)
	...
	fn sudo() -> Weight {
		...
		Weight::from_parts(13_942_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:0)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(20), added: 515, mode: `MaxEncodedLen`)
	fn sudo_as() -> Weight {
		...
		Weight::from_parts(13_547_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:1)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(20), added: 515, mode: `MaxEncodedLen`)
	fn remove_key() -> Weight {
		...
		Weight::from_parts(18_749_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:0)
	...
	fn check_only_sudo_account() -> Weight {
		...
		Weight::from_parts(4_107_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
