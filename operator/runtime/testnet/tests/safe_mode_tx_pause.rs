...
mod safe_mode {
    ...
    fn force_enter_requires_root() {
        ExtBuilder::default()
            ...
            .build()
            .execute_with(|| {
                assert_ok!(RuntimeCall::SafeMode(pallet_safe_mode::Call::force_enter {})
                ...
                System::assert_last_event(RuntimeEvent::SafeMode(
                    pallet_safe_mode::Event::<Runtime>::Entered {
...
mod combined_behaviour {
    ...
    fn control_plane_calls_work_under_restrictions() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                assert_ok!(pallet_safe_mode::Call::<Runtime>::force_enter {
                    duration: SafeMode::default_enter_duration()
                }
                .dispatch(RuntimeOrigin::root()));
